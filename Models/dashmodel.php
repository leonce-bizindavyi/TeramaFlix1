...
public function Demande(){
  ...
  $tab = array(array(1,1,31) ,array(2,1,29),array(3,1,31),
     ...
     $nombre  = "SELECT distinct (count(ID) ) from posts where categorie='ct4'and Created_at between '".$debut."' and   '".$fin."' ";
   ...
   function chart_film(){
    ...
    $nombre= "SELECT COUNT(ID) AS count FROM posts where categorie='ct1' and Created_at between '".$debut."'AND '".$fin."'";
    $result = $this->db->query($nombre);
    $row = $result->getRow();
 ...
 function chart_series(){
  ...
  $nombre= "SELECT COUNT(ID) AS count FROM posts where categorie='ct2' and Created_at between '".$debut."'AND '".$fin."'";
  $result = $this->db->query($nombre);
  $row = $result->getRow();
...
function chart_Anime(){
  ...
  $nombre= "SELECT COUNT(ID) AS count FROM posts where categorie='ct3' and Created_at between '".$debut."'AND '".$fin."'";
  $result = $this->db->query($nombre);
  $row = $result->getRow();
...
function chart_Demande(){
  ...
  $nombre= "SELECT COUNT(ID) AS count FROM posts where categorie='ct4' and Created_at between '".$debut."'AND '".$fin."'";
  $result = $this->db->query($nombre);
  $row = $result->getRow();
